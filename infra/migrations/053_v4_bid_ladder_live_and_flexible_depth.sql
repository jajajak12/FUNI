...
ALTER TABLE v4_bid_ladder_legs RENAME TO v4_bid_ladder_legs_053_old;
ALTER TABLE v4_bid_ladders RENAME TO v4_bid_ladders_053_old;
...
INSERT INTO v4_bid_ladders SELECT * FROM v4_bid_ladders_053_old;
INSERT INTO v4_bid_ladder_legs SELECT * FROM v4_bid_ladder_legs_053_old;

DROP TABLE v4_bid_ladder_legs_053_old;
DROP TABLE v4_bid_ladders_053_old;
