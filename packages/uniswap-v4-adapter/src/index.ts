...
export async function permit2Allowance(rpc:FallbackRpc,owner:Address,token:Address,spender:Address,blockNumber?:bigint){return rpc.withClient(client=>client.readContract({address:V4_ROBINHOOD_DEPLOYMENTS.permit2,abi:permit2Abi,functionName:'allowance',args:[owner,token,spender],blockNumber}),{stage:'allowance_preflight',method:'Permit2.allowance'});}
