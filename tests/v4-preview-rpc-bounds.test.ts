...
vi.mock('@funi/v4',async importOriginal=>{
 const actual=await importOriginal<typeof import('@funi/v4')>();
...
import { V4_ROBINHOOD_DEPLOYMENTS,type V4PoolKey } from '@funi/v4';
